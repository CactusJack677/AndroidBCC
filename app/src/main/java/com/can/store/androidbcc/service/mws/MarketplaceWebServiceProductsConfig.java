...
package com.can.store.androidbcc.service.mws;
...
public class MarketplaceWebServiceProductsConfig {
    ...
    /**
     * Sets SignatureVersion property and returns current MarketplaceWebServiceProductsConfig
     *
     * @param signatureVersion
     *            Signature Version for signing requests
     *
    ...
    /**
     * Sets SignatureMethod property and returns current MarketplaceWebServiceProductsConfig
     *
     * @param signatureMethod
     *            Signature Method for signing requests
     *
    ...
    /**
     * Sets UserAgent property and returns current MarketplaceWebServiceProductsConfig
     *
     *            User Agent String to use when sending request
     *
     * @return MarketplaceWebServiceProductsConfig
     */
    public MarketplaceWebServiceProductsConfig withUserAgent(String applicationName, String applicationVersion, String programmingLanguage, String... additionalNameValuePairs) {
        setUserAgent(applicationName, applicationVersion, programmingLanguage, additionalNameValuePairs);
        return this;
    }
    ...
    /**
     * Sets ServiceURL property and returns current MarketplaceWebServiceProductsConfig
     *
     * @param serviceURL
     *            Service Endpoint URL
     *
    ...
    /**
     * Sets ProxyHost property and returns current MarketplaceWebServiceProductsConfig
     *
     * @param proxyHost
     *            Proxy Host for connection
     *
    ...
    /**
     * Sets ProxyPort property and returns current MarketplaceWebServiceProductsConfig
     *
     * @param proxyPort
     *            Proxy Port for connection
     *
    ...
    /**
     * Sets ProxyUsername property and returns current MarketplaceWebServiceProductsConfig
     *
     * @param proxyUsername
     *            Proxy Username for connection
     *
    ...
    /**
     * Sets ProxyPassword property and returns current MarketplaceWebServiceProductsConfig
     *
     * @param proxyPassword
     *            Proxy Password for connection
     *
    ...
    /**
     * Sets MaxErrorRetry property and returns current MarketplaceWebServiceProductsConfig
     *
     * @param maxErrorRetry
     *            Max number of retries on 500th errors
     *
    ...
    /**
     * Sets MaxConnections property and returns current MarketplaceWebServiceProductsConfig
     *
     * @param maxConnections
     *            Max number of http connections
     *
